    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToDoTasks_TaskPriorities_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "TaskPriorities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToDoTasks_TaskStatuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Blue category", "Blue" },
                    { 2, "Green category", "Green" },
                    { 3, "Red category", "Red" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Task not started yet.", "Not Started" },
                    { 2, "Task already started but not completed.", "In progress" },
